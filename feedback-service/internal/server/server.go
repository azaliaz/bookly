...
import (
	...
	"github.com/azaliaz/bookly/feedback-service/internal/config"
...
type Storage interface {
	...
	GetFeedbacksByBookDesc(string) ([]models.Feedback, error)
	GetFeedbacksByBookAsc(string) ([]models.Feedback, error)
	GetFeedbacksByUserAsc(string) ([]models.Feedback, error)
	GetFeedbacksByUserDesc(string) ([]models.Feedback, error)
...
func (s *Server) Run(ctx context.Context) error {
	...
	{
		feedback.POST("/", s.JWTAuthMiddleware(), s.saveFeedback)
		feedback.GET("/book/:book_id/asc", s.getFeedbacksByBookAsc)
		feedback.GET("/book/:book_id/desc", s.getFeedbacksByBookDesc)
		feedback.GET("/book/:book_id", s.getFeedbacksByBookAsc)
		feedback.GET("/user/:user_id", s.JWTAuthMiddleware(), s.getFeedbacksByUserAsc)
		feedback.GET("/user/:user_id/asc", s.JWTAuthMiddleware(), s.getFeedbacksByUserAsc)
		feedback.GET("/user/:user_id/desc", s.JWTAuthMiddleware(), s.getFeedbacksByUserDesc)
		feedback.DELETE("/:feedback_id", s.JWTAuthMiddleware(), s.deleteFeedback)
